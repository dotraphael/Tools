...
************************************************************************************************************************/
DECLARE  @CMSiteCode  nchar(3) = N'' -- This is the Site Code you are going to use for this CM Site.
        ,@ExecuteCmds bit = 0; -- 0 = Testing; Change this to 1 in order to actually create the database!
